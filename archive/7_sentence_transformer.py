...
st.markdown("### Query: sozialstation an der bedürftige beratungen in anspruch nehmen können")
st.code("""
...
...""")
st.markdown("### Query: tafel und lebensmittelausgabe für bedürftige menschen")
st.code("""
Tafel versorgt im Notbetrieb 150 hilfsbedürftige P
